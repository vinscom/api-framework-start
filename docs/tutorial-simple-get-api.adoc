...
*/config-layers/tutorial-simple-get-api/in/erail/tutorial/SessionService*

[source,ini,linenums]
----
include::./../config-layers/tutorial-simple-get-api/in/erail/tutorial/SessionService.properties[]
----
